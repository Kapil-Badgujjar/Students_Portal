...
export default function Navbar() {
  return (
    <nav className="fixed top-0 w-full z-10 shadow-md shadow-white/30">
        <div className='grid grid-cols-2 lg:grid-cols-3 lg:justify-items-center items-center py-2 px-5 bg-black text-white'>
          <div className="flex gap-3 text-2xl hidden lg:block">
            <Link href='/' className="hover:bg-[#457B9D] p-2 rounded-md">Home</Link>
